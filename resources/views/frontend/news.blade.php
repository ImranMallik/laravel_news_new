                                                    ...
                                                    <div class="card__post__content">
                                                        ...
                                                        <div class="card__post__author-info mb-2">
                                                            <ul class="list-inline">
                                                                <li class="list-inline-item">
                                                                    <span class="text-primary">
                                                                        {{ __('by') }} {{ $recentNew->auther->name }}
                                                                    </span>
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <span class="text-dark text-capitalize">
                                                                        {{ date('M d, Y', strtotime($recentNew->created_at)) }}
                                                                    </span>
                                                                </li>
                                ...
                                @foreach ($recentNews as $recentNew)
                                    @if ($loop->index > 2)
                                        <div class="article__entry">
                                            <div class="article__image">
                                                <a href="{{ route('news.details', $recentNew->slug) }}">
                                                    <img src="{{ asset($recentNew->image) }}" alt=""
                                                        class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="article__content">
                                                ...
                                                <p>
                                                    {!! truncate($recentNew->content, 100) !!}
                                                </p>
                                                <a href="{{ route('news.details', $recentNew->slug) }}"
                                                    class="btn btn-outline-primary mb-4 text-capitalize">
                                                    {{ __('read
                ...
                <div class="pagination-area">
                    <div class="pagination wow fadeIn animated" data-wow-duration="2s" data-wow-delay="0.5s">
                        ...
                        @if ($news->currentPage() > 1)
                            <a
                                href="{{ $news->url(1) . (request()->except('page') ? '&' . http_build_query(request()->except('page')) : '') }}">
                                <span>«</span>
                            </a>
                        @else
                        @endif
                        ...
                        @if ($news->currentPage() < $news->lastPage())
                            <a
                                href="{{ $news->url($news->lastPage()) . (request()->except('page') ? '&' . http_build_query(request()->except('page')) : '') }}">
                                <span>»</span>
                            </a>
                        @else
                            <span>»</span>
