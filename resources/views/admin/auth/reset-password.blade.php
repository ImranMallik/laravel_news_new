...
<head>
    ...
    <title>{{ __('Admin') }} &mdash; {{ __('Reset Password') }}</title>
                    ...
                    <div
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('admin.add-new-password') }}"
                                    class="needs-validation" novalidate="">
                                    @csrf
                                    <div class="form-group">
                                        <label for="email">{{ __('Email') }}</label>
                                        <input id="email" type="email" value="{{ @request()->email }}"
                                ...
                                <div class="simple-footer">
                                    {{ __('Copyright') }} &copy; {{ __('Imran 2025') }}
                                </div>
                            </div>
                        </div>
                    </div>
