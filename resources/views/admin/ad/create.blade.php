             ...
             <div class="card-body">
                 <form action="{{ route('admin.ads.update', 1) }}" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                         <img src="{{ asset($ad->home_top_bar_ad) }}" width="100px" height="100px" alt="">
                         <br>
                     ...
                     <div class="form-group">
                         <img src="{{ asset($ad->home_middle_ad) }}" width="100px" height="100px" alt="">
                         <br>
                     ...
                     <div class="form-group">
                         <img src="{{ asset($ad->view_page_ad) }}" width="100px" height="100px" alt="">
                         <br>
                     ...
                     <div class="form-group">
                         <img src="{{ asset($ad->news_page_ad) }}" width="100px" height="100px" alt="">
                         <br>
                         <label for="">{{ __('Bottom Ad') }}</label>
                     ...
                     <div class="form-group">
                         <img src="{{ asset($ad->side_bar_ad) }}" width="100px" height="100px" alt="">
                         <br>
